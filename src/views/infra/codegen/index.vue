<template>
  <doc-alert v-if="false" title="代码生成（单表）" url="https://doc.iocoder.cn/new-feature/" />
  <doc-alert v-if="false" title="代码生成（树表）" url="https://doc.iocoder.cn/new-feature/tree/" />
  <doc-alert v-if="false" title="代码生成（主子表）" url="https://doc.iocoder.cn/new-feature/master-sub/" />
  <doc-alert v-if="false" title="单元测试" url="https://doc.iocoder.cn/unit-test/" />
