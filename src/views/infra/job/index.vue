<template>
  <doc-alert v-if="false" title="定时任务" url="https://doc.iocoder.cn/job/" />
  <doc-alert v-if="false" title="异步任务" url="https://doc.iocoder.cn/async-task/" />
  <doc-alert v-if="false" title="消息队列" url="https://doc.iocoder.cn/message-queue/" />
