<template>
  <doc-alert v-if="false" title="数据库 MyBatis" url="https://doc.iocoder.cn/mybatis/" />
  <doc-alert v-if="false" title="多数据源（读写分离）" url="https://doc.iocoder.cn/dynamic-datasource/" />
