<template>
  <doc-alert v-if="false" title="【商机】商机管理、商机状态" url="https://doc.iocoder.cn/crm/business/" />
  <doc-alert v-if="false" title="【通用】数据权限" url="https://doc.iocoder.cn/crm/permission/" />
...
const list = ref<BusinessStatusApi.BusinessStatusTypeVO[]>([]) // 列表的数据
