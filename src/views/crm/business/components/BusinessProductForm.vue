...
const formData = ref<BusinessApi.BusinessProductItemVO[]>([])
...
/** 新增按钮操作 */
const handleAdd = () => {
  const row: BusinessApi.BusinessProductItemVO = {
    id: undefined,
    productId: undefined,
...
/** 处理产品变更 */
const onChangeProduct = (productId: number, row: BusinessApi.BusinessProductItemVO) => {
