...
import { StockOutApi, type StockOutItemVO, StockOutVO } from '@/api/erp/stock/out'
...
const createFormData = (): StockOutFormData => ({
  id: undefined,
...
const formData = ref<StockOutFormData>(createFormData())
...
const itemFormRef = ref<InstanceType<typeof StockOutItemForm>>()
