...
import { StockCheckApi, type StockCheckItemVO, StockCheckVO } from '@/api/erp/stock/check'
...
const createFormData = (): StockCheckFormData => ({
  id: undefined,
  checkTime: undefined,
  remark: undefined,
  fileUrl: '',
...
const formData = ref<StockCheckFormData>(createFormData())
...
const itemFormRef = ref<InstanceType<typeof StockCheckItemForm>>()
