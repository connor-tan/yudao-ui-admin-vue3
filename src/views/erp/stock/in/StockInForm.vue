...
import { StockInApi, type StockInItemVO, StockInVO } from '@/api/erp/stock/in'
...
const createFormData = (): StockInFormData => ({
  id: undefined,
...
const formData = ref<StockInFormData>(createFormData())
...
const itemFormRef = ref<InstanceType<typeof StockInItemForm>>()
