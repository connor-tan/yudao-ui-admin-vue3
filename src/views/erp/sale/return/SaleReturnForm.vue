...
const createFormData = (): SaleReturnVO => ({
  id: undefined,
...
const formData = ref<SaleReturnVO>(createFormData())
...
const itemFormRef = ref<InstanceType<typeof SaleReturnItemForm>>()
...
/** 打开【可退货的订单列表】弹窗 */
const saleOrderReturnEnableListRef = ref<InstanceType<typeof SaleOrderReturnEnableList>>() // 可退货的订单列表 Ref
