...
const lineChartOptions = reactive<EChartsOption>({
  ...
  series: [
    { name: '商品浏览量', type: 'line' as const, smooth: true, itemStyle: { color: '#B37FEB' } },
    { name: '商品访客数', type: 'line' as const, smooth: true, itemStyle: { color: '#FFAB2B' } },
    { name: '支付金额', type: 'bar' as const, yAxisIndex: 1, itemStyle: { color: '#1890FF' } },
    { name: '退款金额', type: 'bar' as const, yAxisIndex: 1, itemStyle: { color: '#00C050' } }
  ],
  toolbox: {
    feature: {
      // 数据区域缩放
