 ...
 * @return 格式化后的数字
 */
export const numberFormatter = (num: number | string | undefined, digit: number) => {
  if (num == null) {
    return ''
  }
 ...
 * @return 格式化后的金额
 */
export const priceTableColumnFormatter = (_, __, cellValue: any, ___) => {
  return numberFormatter(cellValue, PRICE_DIGIT)
}
